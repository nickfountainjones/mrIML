...
<!-- badges: start -->
![GitHub R package version](https://img.shields.io/github/r-package/v/nickfountainjones/mrIML?logo=github&logoColor=%2300ff37&style=flat-square)
![GitHub contributors](https://img.shields.io/github/contributors/nickfountainjones/mrIML?style=flat-square)
![GitHub last commit](https://img.shields.io/github/last-commit/nickfountainjones/mrIML?style=flat-square)
[![R-CMD-check](https://github.com/nickfountainjones/mrIML/workflows/R-CMD-check/badge.svg)](https://github.com/nickfountainjones/mrIML/actions)
[![Codecov test coverage](https://codecov.io/gh/nickfountainjones/mrIML/graph/badge.svg)](https://app.codecov.io/gh/nickfountainjones/mrIML)
<!-- badges: end -->
...
**mrIML** is designed to be used with a single function call or to be used in an ad-hoc fashion via individual function calls. In the following section we give an overview of the simple use case. For more on using each function see the [function documentation](https://nickfountainjones.github.io/mrIML/reference/index.html). The core functions for both regression and classification are: [`mrIMLpredicts`](https://nickfountainjones.github.io/mrIML/reference/mrIMLpredicts.html),
[`mrIMLperformance`](https://nickfountainjones.github.io/mrIML/reference/mrIMLperformance.html), and 
[`mrvip`](https://nickfountainjones.github.io/mrIML/reference/mrvip.html), [`mrFlashlight`](https://nickfountainjones.github.io/mrIML/reference/mrFlashlight.html), and[`mrProfileplots`](https://nickfountainjones.github.io/mrIML/reference/mrProfileplots.html).

We also allow users to get bootstrapped estimations of partial dependencies and variable importance using [`mrBootstrap`](https://nickfountainjones.github.io/mrIML/reference/mrBootstrap.html). 
...
model_rf <- rand_forest(
  ...
  mtry = tune(),
  min_n = tune()
) %>% # 100 trees are set for brevity. Aim to start with 1000
  set_engine("randomForest")
```
### [`mrIMLpredicts`](https://nickfountainjones.github.io/mrIML/reference/mrIMLpredicts.html)
...
yhats_rf <- mrIMLpredicts(
  X = X, Y = Y, # specify which data to use
