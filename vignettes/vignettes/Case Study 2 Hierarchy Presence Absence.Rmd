...
4 dataframes, one containing all the environmental elements and one for
...
Models are trained for environment without co-occurance, co-occurance
without the environmental variable, a combined model and a combined
grouped by site.

```{r training models, echo= TRUE, results="hide", message= FALSE, warning=FALSE}
