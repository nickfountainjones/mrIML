...
## Co-occurance Networks {.tabset}

Using the bootstrapping variables from the previous section we can also build 
co-occurance networks.

### Beetles

```{r Beetles Co-occurance Networks, echo=TRUE}
...
```{r Plots - Beetles Network, echo = TRUE}
...
```{r Birds Co-occurance Networks, echo=TRUE}
...
```{r Plots - Birds Network, echo = TRUE}
## Network visualization Beetles
...
```{r Plants Co-occurance Networks, echo=TRUE}
...
```{r Plots - Plants Network, echo = TRUE}
## Network visualization Beetles
...
```{r Importance Plots Beetles, echo = TRUE}
vi_beetles[[3]]
vi_beetles_H[[3]]
```
...
```{r Importance Plots Birds, echo = TRUE}
vi_birds[[3]]
vi_birds_H[[3]]
```


```{r Importance Plots Plants, echo = TRUE}
vi_plants[[3]]
vi_plants_H[[3]]
```
